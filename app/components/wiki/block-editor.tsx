...
const SNIPPETS: Snippet[] = [
  ...
  { label: "Var def", icon: <Braces className="size-3.5" />, text: "{{var:varName=100|What this variable controls}}" },
  { label: "Var def global", icon: <Braces className="size-3.5" />, text: "{{var:global:varName=100|A project-wide default any page can override}}" },
  { label: "Var def styled", icon: <Braces className="size-3.5" />, text: "{{var:varName=100|What it controls|:good[varName] = :white[100]}}" },
  { label: "Var ref", icon: <Braces className="size-3.5" />, text: "{{varName}}" },
  { label: "Term def", icon: <Braces className="size-3.5" />, text: "{{term:Hearing|A **formatted** explanation shown on hover}}" },
  { label: "Term def global", icon: <Braces className="size-3.5" />, text: "{{term:global:Hearing|How well an entity hears}}" },
  { label: "Term anchor", icon: <Braces className="size-3.5" />, text: "{{term:Hearing}}" },
  { label: "Term ref", icon: <Braces className="size-3.5" />, text: "{{Hearing}}" },
  { label: "Term ref note", icon: <Braces className="size-3.5" />, text: "{{Hearing|A note shown only on this reference}}" },
